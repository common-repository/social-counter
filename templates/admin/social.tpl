	...
	<div class="prisna_social_counter_setting{{ title.false:begin }} prisna_social_counter_setting_no_title{{ title.false:end }}">
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tbody>
				...
				{{ extra_description.true:begin }}
				<tr>
					<td colspan="3" class="prisna_social_counter_shortcode_container">{{ extra_description_title }}<br/><div class="prisna_social_counter_shortcode">{{ extra_description_message }}</div></td>
				</tr>
				{{ extra_description.true:end }}
				<tr>

	...
	public static function getDefaults($_force=false) {
		...
		$result = array(
			...
			'facebook' => array(
				...
				'extra_description_title' => __('Important notice', 'prisna-social-counter'),
				'extra_description_message' => __('Make sure the facebook page is published, it\'s not private and it\'s publicly accessible without being logged in. You may open the page in a private/incognito browser session to test if it\'s ready.', 'prisna-social-counter'),

...
class PrisnaSocialCounterSocialField extends PrisnaSocialCounterField {
	...
	public $extra_description_title;
	public $extra_description_message;
	...
	public function output($_html_encode=false) {
		...
		$result = parent::render(array(
			...
			'meta_tag_rules' => array(
				array(
					'expression' => !empty($this->extra_description_title) || !empty($this->extra_description_message),
					'tag' => 'extra_description'
				)
			)
		), $_html_encode);
